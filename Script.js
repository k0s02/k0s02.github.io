    ...
    switch(object)
        {
            case 'creature_generator':
                ...
                var SQL = "INSERT INTO creature_template (entry, name, subname, gossip_menu_id, modelid1, faction, npcflag, flags_extra, AIName) VALUES (" + entry + ", " + name + ", " + subName + ", " + gossipid + ", " + modelid + ", " + factionid + ", " + npcflags_value + ", " + flagsextra_value + ", " + smart + ");\n";
                textarea.value = SQL;
                copyText('textarea');
              break;
        }
