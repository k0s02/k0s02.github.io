...
function sendData(object){
    ...
    var maxlvl = 110; 
                ...
                var SQL = "INSERT INTO creature_template (entry, gossip_menu_id, minlevel, maxlevel, faction, npcflag, flags_extra, flags_extra2, AIName) VALUES (" + entry + ", " + gossipid + ", " + minlvl + ", " + maxlvl + ", " + factionid + ", " + npcflags_value + ", " + flagsextra_value + ", " + flagsextra2_value + ", " + smart + ") INSERT INTO creature_template_wdb (Entry, Name1, Title, DisplayId1) VALUES (" + entry + ", " + name + ", " + subName + ", " + modelid + ")";
